...
static void ImGui_ImplWin32_UpdateGamepads() {
    ...
    if (bd->WantUpdateHasGamepad) {
        ...
        bd->HasGamepad = bd->XInputGetCapabilities ? (bd->XInputGetCapabilities(0, XINPUT_FLAG_GAMEPAD, &caps) ==
                                                      ERROR_SUCCESS) : false;
...
void ImGui_ImplWin32_EnableDpiAwareness() {
    if (_IsWindows10OrGreater()) {
        ...
        if (PFN_SetThreadDpiAwarenessContext SetThreadDpiAwarenessContextFn = (PFN_SetThreadDpiAwarenessContext) ::GetProcAddress(
    ...
    if (_IsWindows8Point1OrGreater()) {
        ...
        if (PFN_SetProcessDpiAwareness SetProcessDpiAwarenessFn = (PFN_SetProcessDpiAwareness) ::GetProcAddress(
